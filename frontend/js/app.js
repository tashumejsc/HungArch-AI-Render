...
(() => {
  ...
  const DRAWING_MODE_HINTS = {
    ...
    '2d_render':               'AI làm đẹp bản vẽ 2D gốc: tô màu vật liệu, làm rõ đường nét — giữ nguyên góc nhìn 2D, không đổi sang 3D.',
  };
  ...
  const _OUTPUT_HINTS_2D = {
    interior: 'Tô màu vật liệu sàn theo từng phòng, đồ nội thất dạng khối phẳng — giữ nguyên mặt bằng 2D.',
    exterior: 'Tô màu cây xanh, đường nội bộ, hồ nước, bãi đỗ xe — giữ nguyên mặt bằng tổng thể 2D.',
  };
