...
GEOMETRY_LOCK = (
    ...
    "IF the model has NO light fixtures at all, you MAY place ONLY simple recessed ceiling "
    "downlights and at most one continuous cove LED strip — DO NOT add decorative pendant lights, "
    "hanging lamps, chandeliers, surface-mounted ceiling fixtures, wall sconces, or any decorative "
    "lighting element not already visible in the model. Either way, the room must end up "
    "realistically and pleasantly lit. "
